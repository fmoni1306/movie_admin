...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/lib/datatable/dataTables.bootstrap.min.css">
...
<body>
		...
		<header id="header" class="header">
			<div class="top-left">
				<div class="navbar-header">
					<a class="navbar-brand" href="<c:url value='/home/main'/>"><img
						src="${pageContext.request.contextPath}/resources/images/logo.png"
						alt="Logo"></a> <a class="navbar-brand hidden" href="<c:url value='/home/main'/>"><img
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                     <c:forEach var="cl" items="${collectionList}">
                                     <tr>
                                     
                                            <td>${cl.idx}</td>
                                            <td>${cl.nick}</td>
                                            <td>${cl.collection_name}</td>
                                            <td>${cl.title}</td>
                                            <td>${cl.content}</td>
                                            <td><button value="${cl.idx}" class="addBtn">첫번 째 메인화면에 추가</button></td>
                                            <td><button value="${cl.idx}" class="addBtn2">두번 째 메인화면에 추가</button></td>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/datatables.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/dataTables.bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/dataTables.buttons.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/buttons.bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/jszip.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/vfs_fonts.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/buttons.html5.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/buttons.print.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/lib/data-table/buttons.colVis.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/init/datatables-init.js"></script>
